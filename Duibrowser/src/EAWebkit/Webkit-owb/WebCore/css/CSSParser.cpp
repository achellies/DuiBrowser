...
{
    // 11/10/09 CSidhall - Added notify start of process to user
	NOTIFY_PROCESS_STATUS(EA::WebKit::kVProcessTypeCSSParseSheet, EA::WebKit::kVProcessStatusStarted);
	...
	NOTIFY_PROCESS_STATUS(EA::WebKit::kVProcessTypeCSSParseSheet, EA::WebKit::kVProcessStatusEnded);
}
