...
struct SVGTextRunWalker: public WTF::FastAllocBase {
...
struct SVGTextRunWalkerMeasuredLengthData: public WTF::FastAllocBase {
    int at;
    int from;
    int to;
...
struct SVGTextRunWalkerDrawTextData: public WTF::FastAllocBase {
    int extraCharsAvailable;
    int charsConsumed;
    String glyphName;
