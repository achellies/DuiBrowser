...
public:
    ...
    WebFrame*   m_pClientWebFrame;          // 3/31/09 CSidhall - Added so can release webframe on destruct for leak fix when using frames
private:
...
public:
    ...
    void setTransparentBackground(const bool active);
