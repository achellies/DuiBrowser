...
//-daw ca
    ...
    // 3/27/09 CSidhall - Extract from procedures to get access for exit leak
    static HashSet<AtomicStringImpl*> m_sTagListRecognized;
    static HashSet<AtomicStringImpl*> m_sTagListInline;
