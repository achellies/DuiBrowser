...
public:
//+daw ca 23/07 static and global management
    static FunctionMap* gFunctionMapList();
    static HashSet<AtomicStringImpl*>* unaffectedTagsList();
    static HashSet<AtomicStringImpl*>* headerTagsList();
    static HashSet<AtomicStringImpl*>* residualStyleTagsList();

    static void staticFinalize();
private:
    static int m_st_iIsEmpty;
    static int m_st_iIsClearing;
//daw ca
