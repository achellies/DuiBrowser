...
void HTMLTableElement::addSharedCellBordersDecl(Vector<CSSMutableStyleDeclaration*>& results)
{
    ...
    //
    const AtomicString cellBorderNames[5] = { noneHTMLTableElement, solidHTMLTableElement, insetHTMLTableElement, solidcolsHTMLTableElement, solidrowsHTMLTableElement };
    ////////////////
