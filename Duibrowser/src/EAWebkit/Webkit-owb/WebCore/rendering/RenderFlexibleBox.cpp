...
class FlexBoxIterator/*: public WTF::FastAllocBase*/ {
public:
    ...
    if (haveLineClamp) {
        ...
        if (numVisibleLines < maxLineCount) {
            for (child = iterator.first(); child; child = iterator.next()) {
                ...
                // static AtomicString ellipsisAndSpaceStr(ellipsisAndSpace, 2); // Moved to below and made non-static by Paul Pedriana, 1/2009. It was allocating memory statically, which is troublesome.
                ...
                const AtomicString ellipsisAndSpaceStr(ellipsisAndSpace, 2); // Moved to here from above by Paul Pedriana, 1/2009.
