...
// CS - Statics init - (This is now moved out from inside HasMap)
HashMap<const Widget*, RenderWidget*>* RenderWidget::m_staticWidgetRendererMap=NULL;
bool RenderWidget::m_staticWidgetHasInit = false;

static HashMap<const Widget*, RenderWidget*>& widgetRendererMap()
{
    // 3/26/09 - CSidhall Move out of function so can remove using staticFinalize
    //    static HashMap<const Widget*, RenderWidget*>* staticWidgetRendererMap = new HashMap<const Widget*, RenderWidget*>;
    if(!RenderWidget::m_staticWidgetHasInit){
        RenderWidget::m_staticWidgetRendererMap = new HashMap<const Widget*, RenderWidget*>;
        RenderWidget::m_staticWidgetHasInit = true;
    }
    return *RenderWidget::m_staticWidgetRendererMap;
}

void RenderWidget::staticFinalize()
{
 if(RenderWidget::m_staticWidgetHasInit)
 {
    delete RenderWidget::m_staticWidgetRendererMap;
    RenderWidget::m_staticWidgetRendererMap = NULL;
    RenderWidget::m_staticWidgetHasInit = false;  
 };
