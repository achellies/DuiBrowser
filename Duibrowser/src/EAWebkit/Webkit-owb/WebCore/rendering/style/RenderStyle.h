...
public:
    ...
    typedef RefCounted<StyleInheritedData> BaseClass;
...
public:
    ...
    static RenderStyle *initDefaultStyle();
...
// attribute setter methods
    ...
    bool setFontDescription(const FontDescription& v);//Nicki Vankoughnett:  MOved to .cpp for debugging / ease of recompiling
    /*{
