...
// ----------------------------------------------------------
RenderStyle* RenderStyle::s_defaultStyle = NULL;
...
void RenderStyle::staticFinalize()
{
    if (s_defaultStyle != NULL)
    {
...
bool RenderStyle::setFontDescription(const FontDescription& v) 
{
    ...
    {
        //It appears that the 'inherited' object will be pointing at the default instance up until it tries
        //to modify any part of it.  When it does try to modify it, the inherited object will have to access it
        //via the 'access()' function.  This will then have 'inherited' pointing at a copy of the object
