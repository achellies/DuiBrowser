...
// Note by Paul Pedriana: This is a fixed version of base64Decode which now properly
// handles whitespace, whereas the original WebCore version did not. This may eventually
// be pushed back to the WebKit trunk.
