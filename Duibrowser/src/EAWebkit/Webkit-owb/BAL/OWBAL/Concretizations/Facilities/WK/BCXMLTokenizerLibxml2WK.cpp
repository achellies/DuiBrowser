...
#if USE(LIBXML2)  // Added by Paul Pedriana. It wraps the entire file.
...
class PendingCallbacks: public WTF::FastAllocBase {
public:
    PendingCallbacks()
    {
...
private:    
    struct PendingCallback: public WTF::FastAllocBase {
...
class OffsetBuffer: public WTF::FastAllocBase {
public:
...
struct _xmlSAX2Namespace: public WTF::FastAllocBase {
...
struct _xmlSAX2Attributes: public WTF::FastAllocBase {
...
#endif // #if USE(LIBXML2)  // Added by Paul Pedriana. It wraps the entire file.
