...
// 4/27/09 CSidhall - Added for leak on exit clean up
//- Old code
//static Bigint* p5s;
//static int p5s_count;

//- New code (added init values also)
...
//abaldeva: 07/30/2009 Initialize the pointer to 0
#if !USE(MULTIPLE_THREADS)
static char* dtoa_result = 0;
#endif
