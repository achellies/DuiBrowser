...
#else
    // We can't #include <stdint.h> because that would be recursive.
    // We need to modify the build environment to not see this directory.
    #include <sys/../stdint.h>  // This is not highly portable.
