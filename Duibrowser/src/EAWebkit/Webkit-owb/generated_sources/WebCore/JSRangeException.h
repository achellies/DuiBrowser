...
public:
    JSRangeException(KJS::JSObject* prototype, RangeException*);
...
KJS::JSValue* jsRangeExceptionPrototypeFunctionToString(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
