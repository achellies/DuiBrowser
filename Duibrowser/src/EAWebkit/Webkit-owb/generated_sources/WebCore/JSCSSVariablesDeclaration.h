...
public:
    JSCSSVariablesDeclaration(KJS::JSObject* prototype, CSSVariablesDeclaration*);
...
KJS::JSValue* toJS(KJS::ExecState*, CSSVariablesDeclaration*);
CSSVariablesDeclaration* toCSSVariablesDeclaration(KJS::JSValue*);

class JSCSSVariablesDeclarationPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    bool getOwnPropertySlot(KJS::ExecState*, const KJS::Identifier&, KJS::PropertySlot&);
    JSCSSVariablesDeclarationPrototype(KJS::ExecState* exec)
        : KJS::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

KJS::JSValue* jsCSSVariablesDeclarationPrototypeFunctionGetVariableValue(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
KJS::JSValue* jsCSSVariablesDeclarationPrototypeFunctionRemoveVariable(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
KJS::JSValue* jsCSSVariablesDeclarationPrototypeFunctionSetVariable(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
KJS::JSValue* jsCSSVariablesDeclarationPrototypeFunctionItem(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
