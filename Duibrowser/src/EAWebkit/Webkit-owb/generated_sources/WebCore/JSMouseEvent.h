...
public:
    JSMouseEvent(KJS::JSObject* prototype, MouseEvent*);
...
KJS::JSValue* jsMouseEventPrototypeFunctionInitMouseEvent(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
