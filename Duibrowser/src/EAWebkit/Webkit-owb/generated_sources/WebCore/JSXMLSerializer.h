...
public:
    JSXMLSerializer(KJS::JSObject* prototype, XMLSerializer*);
...
KJS::JSValue* jsXMLSerializerPrototypeFunctionSerializeToString(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
