...
public:
    JSCanvasPixelArray(KJS::JSObject* prototype, CanvasPixelArray*);
...
KJS::JSValue* toJS(KJS::ExecState*, CanvasPixelArray*);
CanvasPixelArray* toCanvasPixelArray(KJS::JSValue*);

class JSCanvasPixelArrayPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    JSCanvasPixelArrayPrototype(KJS::ExecState* exec)
