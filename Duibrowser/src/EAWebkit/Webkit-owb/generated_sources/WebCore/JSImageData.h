...
public:
    JSImageData(KJS::JSObject* prototype, ImageData*);
    virtual ~JSImageData();
...
KJS::JSValue* toJS(KJS::ExecState*, ImageData*);
ImageData* toImageData(KJS::JSValue*);

class JSImageDataPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    JSImageDataPrototype(KJS::ExecState* exec)
