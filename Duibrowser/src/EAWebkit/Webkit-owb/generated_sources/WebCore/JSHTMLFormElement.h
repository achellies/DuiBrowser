...
public:
    JSHTMLFormElement(KJS::JSObject* prototype, HTMLFormElement*);
...
KJS::JSValue* jsHTMLFormElementPrototypeFunctionSubmit(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
KJS::JSValue* jsHTMLFormElementPrototypeFunctionReset(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
