...
static const HashTableValue JSHTMLFieldSetElementTableValues[3] =
{
...
JSObject* JSHTMLFieldSetElementPrototype::self(ExecState* exec)
{
    ...
    const Identifier prototypeIdentifier(exec, "[[JSHTMLFieldSetElement.prototype]]");
    return KJS::cacheGlobalObject<JSHTMLFieldSetElementPrototype>(exec, prototypeIdentifier);
}
...
{
    // Changed by Paul Pedriana (1/2009), as the static new was creating a memory leak. If this gets called a lot then we can consider making it a static pointer that's freed on shutdown.
    const Identifier constructorIdentifier(exec, "[[HTMLFieldSetElement.constructor]]");
    return KJS::cacheGlobalObject<JSHTMLFieldSetElementConstructor>(exec, constructorIdentifier);
}
