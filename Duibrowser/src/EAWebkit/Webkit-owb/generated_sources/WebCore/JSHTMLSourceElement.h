...
public:
    JSHTMLSourceElement(KJS::JSObject* prototype, HTMLSourceElement*);
    ...
    enum {
        // Attributes
        SrcAttrNum, TypeAttrNum, MediaAttrNum, 
...
class JSHTMLSourceElementPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    JSHTMLSourceElementPrototype(KJS::ExecState* exec)
