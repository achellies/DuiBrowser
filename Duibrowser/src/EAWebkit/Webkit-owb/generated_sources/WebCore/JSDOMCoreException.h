...
public:
    JSDOMCoreException(KJS::JSObject* prototype, DOMCoreException*);
...
KJS::JSValue* toJS(KJS::ExecState*, DOMCoreException*);
DOMCoreException* toDOMCoreException(KJS::JSValue*);

class JSDOMCoreExceptionPrototype : public KJS::JSObject {
public:
    ...
    KJS::JSValue* getValueProperty(KJS::ExecState*, int token) const;
    JSDOMCoreExceptionPrototype(KJS::ExecState* exec)
        : KJS::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

KJS::JSValue* jsDOMCoreExceptionPrototypeFunctionToString(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
