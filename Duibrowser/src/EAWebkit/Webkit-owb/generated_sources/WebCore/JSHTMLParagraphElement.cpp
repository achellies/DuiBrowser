...
JSObject* JSHTMLParagraphElementPrototype::self(ExecState* exec)
{
    ...
    const Identifier prototypeIdentifier(exec, "[[JSHTMLParagraphElement.prototype]]");
    return KJS::cacheGlobalObject<JSHTMLParagraphElementPrototype>(exec, prototypeIdentifier);
}
...
void JSHTMLParagraphElement::put(ExecState* exec, const Identifier& propertyName, JSValue* value)
{
    lookupPut<JSHTMLParagraphElement, Base>(exec, propertyName, value, &JSHTMLParagraphElementTable, this);
}
...
{
    // Changed by Paul Pedriana (1/2009), as the static new was creating a memory leak. If this gets called a lot then we can consider making it a static pointer that's freed on shutdown.
    const Identifier constructorIdentifier(exec, "[[HTMLParagraphElement.constructor]]");
    return KJS::cacheGlobalObject<JSHTMLParagraphElementConstructor>(exec, constructorIdentifier);
}
