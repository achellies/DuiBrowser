...
public:
    JSCSSValueList(KJS::JSObject* prototype, CSSValueList*);
...
KJS::JSValue* jsCSSValueListPrototypeFunctionItem(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
