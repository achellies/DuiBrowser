...
public:
    JSXMLHttpRequestProgressEvent(KJS::JSObject* prototype, XMLHttpRequestProgressEvent*);
    ...
    enum {
        // Attributes
        PositionAttrNum, TotalSizeAttrNum, 
...
class JSXMLHttpRequestProgressEventPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    JSXMLHttpRequestProgressEventPrototype(KJS::ExecState* exec)
        : KJS::JSObject(JSProgressEventPrototype::self(exec)) { }
};
