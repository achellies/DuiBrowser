...
public:
    JSEventException(KJS::JSObject* prototype, EventException*);
...
KJS::JSValue* toJS(KJS::ExecState*, EventException*);
EventException* toEventException(KJS::JSValue*);

class JSEventExceptionPrototype : public KJS::JSObject {
public:
    ...
    KJS::JSValue* getValueProperty(KJS::ExecState*, int token) const;
    JSEventExceptionPrototype(KJS::ExecState* exec)
        : KJS::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

KJS::JSValue* jsEventExceptionPrototypeFunctionToString(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
