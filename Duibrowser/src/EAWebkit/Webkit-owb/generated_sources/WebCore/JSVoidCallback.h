...
public:
    JSVoidCallback(KJS::JSObject* prototype, VoidCallback*);
...
KJS::JSValue* toJS(KJS::ExecState*, VoidCallback*);
VoidCallback* toVoidCallback(KJS::JSValue*);

class JSVoidCallbackPrototype : public KJS::JSObject {
public:
    static KJS::JSObject* self(KJS::ExecState*);
    virtual const KJS::ClassInfo* classInfo() const { return &s_info; }
    static const KJS::ClassInfo s_info;
    bool getOwnPropertySlot(KJS::ExecState*, const KJS::Identifier&, KJS::PropertySlot&);
    JSVoidCallbackPrototype(KJS::ExecState* exec)
        : KJS::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

KJS::JSValue* jsVoidCallbackPrototypeFunctionHandleEvent(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
