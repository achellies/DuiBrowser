...
public:
    JSXPathNSResolver(KJS::JSObject* prototype, XPathNSResolver*);
...
KJS::JSValue* jsXPathNSResolverPrototypeFunctionLookupNamespaceURI(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
