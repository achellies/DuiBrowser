...
public:
    JSXMLHttpRequestException(KJS::JSObject* prototype, XMLHttpRequestException*);
...
KJS::JSValue* toJS(KJS::ExecState*, XMLHttpRequestException*);
XMLHttpRequestException* toXMLHttpRequestException(KJS::JSValue*);

class JSXMLHttpRequestExceptionPrototype : public KJS::JSObject {
public:
    ...
    KJS::JSValue* getValueProperty(KJS::ExecState*, int token) const;
    JSXMLHttpRequestExceptionPrototype(KJS::ExecState* exec)
        : KJS::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

KJS::JSValue* jsXMLHttpRequestExceptionPrototypeFunctionToString(KJS::ExecState*, KJS::JSObject*, KJS::JSValue*, const KJS::ArgList&);
} // namespace WebCore
