...
JSObject* JSHTMLFrameElementPrototype::self(ExecState* exec)
{
    ...
    const Identifier prototypeIdentifier(exec, "[[JSHTMLFrameElement.prototype]]");
    return KJS::cacheGlobalObject<JSHTMLFrameElementPrototype>(exec, prototypeIdentifier);
}
...
void JSHTMLFrameElement::put(ExecState* exec, const Identifier& propertyName, JSValue* value)
{
    lookupPut<JSHTMLFrameElement, Base>(exec, propertyName, value, &JSHTMLFrameElementTable, this);
}
...
{
    // Changed by Paul Pedriana (1/2009), as the static new was creating a memory leak. If this gets called a lot then we can consider making it a static pointer that's freed on shutdown.
    const Identifier constructorIdentifier(exec, "[[HTMLFrameElement.constructor]]");
    return KJS::cacheGlobalObject<JSHTMLFrameElementConstructor>(exec, constructorIdentifier);
}
