...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSHTMLEmbedElement.prototype]]");
    return JSC::cacheGlobalObject<JSHTMLEmbedElementPrototype>(exec, *prototypeIdentifier);
}
...
{
    static const Identifier* constructorIdentifier = new Identifier(exec, "[[HTMLEmbedElement.constructor]]");
    return JSC::cacheGlobalObject<JSHTMLEmbedElementConstructor>(exec, *constructorIdentifier);
}
