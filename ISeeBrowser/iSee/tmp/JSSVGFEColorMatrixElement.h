...
public:
    JSSVGFEColorMatrixElement(JSC::JSObject* prototype, SVGFEColorMatrixElement*);
...
public:
    ...
    JSC::JSValue* getValueProperty(JSC::ExecState*, int token) const;
    JSSVGFEColorMatrixElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSSVGElementPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsSVGFEColorMatrixElementPrototypeFunctionGetPresentationAttribute(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
