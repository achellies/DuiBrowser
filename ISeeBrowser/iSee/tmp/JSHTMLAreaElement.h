...
public:
    JSHTMLAreaElement(JSC::JSObject* prototype, HTMLAreaElement*);
    ...
    enum {
        ...
        NoHrefAttrNum, ShapeAttrNum, TargetAttrNum, HashAttrNum, 
        HostAttrNum, HostnameAttrNum, PathnameAttrNum, PortAttrNum, 
        ProtocolAttrNum, SearchAttrNum, 
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSHTMLAreaElementPrototype(JSC::ExecState* exec)
