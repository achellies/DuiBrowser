...
static const HashTable JSSVGDefinitionSrcElementPrototypeTable = { 0, JSSVGDefinitionSrcElementPrototypeTableValues, 0 };
...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSSVGDefinitionSrcElement.prototype]]");
    return JSC::cacheGlobalObject<JSSVGDefinitionSrcElementPrototype>(exec, *prototypeIdentifier);
}

const ClassInfo JSSVGDefinitionSrcElement::s_info = { "SVGDefinitionSrcElement", &JSSVGElement::s_info, 0 , 0 };

JSSVGDefinitionSrcElement::JSSVGDefinitionSrcElement(JSObject* prototype, SVGDefinitionSrcElement* impl)
