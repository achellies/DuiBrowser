...
public:
    JSDocumentFragment(JSC::JSObject* prototype, DocumentFragment*);
...
public:
    ...
    JSDocumentFragmentPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSEventTargetNodePrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsDocumentFragmentPrototypeFunctionQuerySelector(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
JSC::JSValue* jsDocumentFragmentPrototypeFunctionQuerySelectorAll(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
