...
static const HashTable JSSVGPathSegClosePathPrototypeTable = { 0, JSSVGPathSegClosePathPrototypeTableValues, 0 };
...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSSVGPathSegClosePath.prototype]]");
    return JSC::cacheGlobalObject<JSSVGPathSegClosePathPrototype>(exec, *prototypeIdentifier);
}

const ClassInfo JSSVGPathSegClosePath::s_info = { "SVGPathSegClosePath", &JSSVGPathSeg::s_info, 0 , 0 };

JSSVGPathSegClosePath::JSSVGPathSegClosePath(JSObject* prototype, SVGPathSegClosePath* impl, SVGElement* context)
