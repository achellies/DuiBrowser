...
public:
    JSNavigator(JSC::JSObject* prototype, Navigator*);
    virtual ~JSNavigator();
    ...
    // Custom attributes
    JSC::JSValue* appVersion(JSC::ExecState*) const;
...
public:
    ...
    JSNavigatorPrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsNavigatorPrototypeFunctionJavaEnabled(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
