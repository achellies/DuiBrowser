...
public:
    JSHTMLIsIndexElement(JSC::JSObject* prototype, HTMLIsIndexElement*);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSHTMLIsIndexElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSHTMLInputElementPrototype::self(exec)) { }
};
