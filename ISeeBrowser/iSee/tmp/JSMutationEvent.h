...
public:
    JSMutationEvent(JSC::JSObject* prototype, MutationEvent*);
...
public:
    ...
    JSC::JSValue* getValueProperty(JSC::ExecState*, int token) const;
    JSMutationEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSEventPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsMutationEventPrototypeFunctionInitMutationEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
