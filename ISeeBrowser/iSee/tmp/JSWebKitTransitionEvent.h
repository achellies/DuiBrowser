...
public:
    JSWebKitTransitionEvent(JSC::JSObject* prototype, WebKitTransitionEvent*);
    ...
    enum {
        // Attributes
        PropertyNameAttrNum, ElapsedTimeAttrNum, 
    };
};
...
public:
    ...
    JSWebKitTransitionEventPrototype(JSC::ExecState* exec)
