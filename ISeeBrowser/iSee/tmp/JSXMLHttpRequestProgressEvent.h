...
public:
    JSXMLHttpRequestProgressEvent(JSC::JSObject* prototype, XMLHttpRequestProgressEvent*);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSXMLHttpRequestProgressEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSProgressEventPrototype::self(exec)) { }
};
