...
public:
    JSSVGFEOffsetElement(JSC::JSObject* prototype, SVGFEOffsetElement*);
...
public:
    ...
    JSSVGFEOffsetElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSSVGElementPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsSVGFEOffsetElementPrototypeFunctionGetPresentationAttribute(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
