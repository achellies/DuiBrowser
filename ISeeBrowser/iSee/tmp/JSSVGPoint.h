...
public:
    JSSVGPoint(JSC::JSObject* prototype, JSSVGPODTypeWrapper<FloatPoint>*, SVGElement* context);
    virtual ~JSSVGPoint();
...
public:
    ...
    JSSVGPointPrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsSVGPointPrototypeFunctionMatrixTransform(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
