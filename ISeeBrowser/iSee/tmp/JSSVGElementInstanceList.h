...
public:
    JSSVGElementInstanceList(JSC::JSObject* prototype, SVGElementInstanceList*);
...
public:
    ...
    JSSVGElementInstanceListPrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsSVGElementInstanceListPrototypeFunctionItem(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
