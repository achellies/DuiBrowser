...
public:
    JSSVGPathSegLinetoHorizontalRel(JSC::JSObject* prototype, SVGPathSegLinetoHorizontalRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegLinetoHorizontalRelPrototype(JSC::ExecState* exec)
