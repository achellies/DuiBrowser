...
public:
    JSSVGPathSegCurvetoQuadraticSmoothAbs(JSC::JSObject* prototype, SVGPathSegCurvetoQuadraticSmoothAbs*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype(JSC::ExecState* exec)
