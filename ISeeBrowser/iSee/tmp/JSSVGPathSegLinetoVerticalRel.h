...
public:
    JSSVGPathSegLinetoVerticalRel(JSC::JSObject* prototype, SVGPathSegLinetoVerticalRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegLinetoVerticalRelPrototype(JSC::ExecState* exec)
