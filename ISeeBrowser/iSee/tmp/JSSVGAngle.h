...
public:
    JSSVGAngle(JSC::JSObject* prototype, SVGAngle*, SVGElement* context);
    virtual ~JSSVGAngle();
...
public:
    ...
    JSC::JSValue* getValueProperty(JSC::ExecState*, int token) const;
    JSSVGAnglePrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsSVGAnglePrototypeFunctionNewValueSpecifiedUnits(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
JSC::JSValue* jsSVGAnglePrototypeFunctionConvertToSpecifiedUnits(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
