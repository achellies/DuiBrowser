...
public:
    JSSQLResultSetRowList(JSC::JSObject* prototype, SQLResultSetRowList*);
...
public:
    ...
    JSSQLResultSetRowListPrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsSQLResultSetRowListPrototypeFunctionItem(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
