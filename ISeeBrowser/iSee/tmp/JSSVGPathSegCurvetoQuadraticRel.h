...
public:
    JSSVGPathSegCurvetoQuadraticRel(JSC::JSObject* prototype, SVGPathSegCurvetoQuadraticRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoQuadraticRelPrototype(JSC::ExecState* exec)
