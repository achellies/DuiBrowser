...
public:
    JSHTMLTextAreaElement(JSC::JSObject* prototype, HTMLTextAreaElement*);
    ...
    enum {
        ...
        RowsAttrNum, TypeAttrNum, ValueAttrNum, WillValidateAttrNum, 
        SelectionStartAttrNum, SelectionEndAttrNum, 
...
public:
    ...
    JSHTMLTextAreaElementPrototype(JSC::ExecState* exec)
