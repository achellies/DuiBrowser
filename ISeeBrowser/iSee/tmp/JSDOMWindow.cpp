...
static const HashTableValue JSDOMWindowTableValues[165] =
{
    ...
    { "TextMetrics", (intptr_t)JSDOMWindow::TextMetricsConstructorAttrNum, DontDelete, 0 },
    ...
    { "XMLHttpRequestUpload", (intptr_t)JSDOMWindow::XMLHttpRequestUploadConstructorAttrNum, DontDelete, 0 },
...
static const HashTableValue JSDOMWindowPrototypeTableValues[22] =
{
    ...
    { "openDatabase", (intptr_t)jsDOMWindowPrototypeFunctionOpenDatabase, DontDelete|Function, 4 },
...
JSValue* JSDOMWindow::getValueProperty(ExecState* exec, int token) const
{
    ...
    case TextMetricsConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
            return jsUndefined();
    ...
    case XMLHttpRequestUploadConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
            return jsUndefined();
...
void JSDOMWindow::putValueProperty(ExecState* exec, int token, JSValue* value)
{
    ...
    case TextMetricsConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
            return;
        // Shadowing a built-in constructor
        putDirect(Identifier(exec, "TextMetrics"), value);
        break;
    }
    case EventConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
    ...
    case XMLHttpRequestUploadConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
            return;
        // Shadowing a built-in constructor
        putDirect(Identifier(exec, "XMLHttpRequestUpload"), value);
        break;
    }
    case XMLHttpRequestExceptionConstructorAttrNum: {
        if (!allowsAccessFrom(exec))
