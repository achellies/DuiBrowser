...
static const HashTableValue JSXMLHttpRequestTableValues[13] =
{
    ...
    { "upload", (intptr_t)JSXMLHttpRequest::UploadAttrNum, DontDelete|ReadOnly, 0 },
...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSXMLHttpRequest.prototype]]");
    return JSC::cacheGlobalObject<JSXMLHttpRequestPrototype>(exec, *prototypeIdentifier);
}
...
JSC::JSValue* toJS(JSC::ExecState* exec, XMLHttpRequest* obj)
{
    return cacheDOMObject<XMLHttpRequest, JSXMLHttpRequest, JSXMLHttpRequestPrototype>(exec, obj);
}
XMLHttpRequest* toXMLHttpRequest(JSC::JSValue* val)
{
