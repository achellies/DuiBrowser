...
static const HashTable JSSVGHKernElementPrototypeTable = { 0, JSSVGHKernElementPrototypeTableValues, 0 };
...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSSVGHKernElement.prototype]]");
    return JSC::cacheGlobalObject<JSSVGHKernElementPrototype>(exec, *prototypeIdentifier);
}

const ClassInfo JSSVGHKernElement::s_info = { "SVGHKernElement", &JSSVGElement::s_info, 0 , 0 };

JSSVGHKernElement::JSSVGHKernElement(JSObject* prototype, SVGHKernElement* impl)
