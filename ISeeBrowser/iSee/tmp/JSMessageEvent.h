...
public:
    JSMessageEvent(JSC::JSObject* prototype, MessageEvent*);
...
public:
    ...
    JSMessageEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSEventPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsMessageEventPrototypeFunctionInitMessageEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
