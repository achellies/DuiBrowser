...
class JSProcessingInstruction : public JSNode {
    typedef JSNode Base;
public:
    JSProcessingInstruction(JSC::JSObject* prototype, ProcessingInstruction*);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSProcessingInstructionPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSNodePrototype::self(exec)) { }
};
