...
public:
    JSSVGPathSegCurvetoQuadraticAbs(JSC::JSObject* prototype, SVGPathSegCurvetoQuadraticAbs*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoQuadraticAbsPrototype(JSC::ExecState* exec)
