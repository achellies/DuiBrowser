...
public:
    JSSVGPathSegCurvetoQuadraticSmoothRel(JSC::JSObject* prototype, SVGPathSegCurvetoQuadraticSmoothRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoQuadraticSmoothRelPrototype(JSC::ExecState* exec)
