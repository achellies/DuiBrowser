...
public:
    JSTextEvent(JSC::JSObject* prototype, TextEvent*);
...
public:
    ...
    JSTextEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSUIEventPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsTextEventPrototypeFunctionInitTextEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
