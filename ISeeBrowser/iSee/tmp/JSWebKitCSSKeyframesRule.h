...
public:
    JSWebKitCSSKeyframesRule(JSC::JSObject* prototype, WebKitCSSKeyframesRule*);
...
public:
    ...
    JSWebKitCSSKeyframesRulePrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSCSSRulePrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsWebKitCSSKeyframesRulePrototypeFunctionInsertRule(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
JSC::JSValue* jsWebKitCSSKeyframesRulePrototypeFunctionDeleteRule(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
JSC::JSValue* jsWebKitCSSKeyframesRulePrototypeFunctionFindRule(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
