...
public:
    JSSVGPathSegLinetoVerticalAbs(JSC::JSObject* prototype, SVGPathSegLinetoVerticalAbs*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegLinetoVerticalAbsPrototype(JSC::ExecState* exec)
