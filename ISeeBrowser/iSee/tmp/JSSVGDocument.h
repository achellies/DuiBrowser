...
public:
    JSSVGDocument(JSC::JSObject* prototype, SVGDocument*);
...
public:
    ...
    JSSVGDocumentPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSDocumentPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsSVGDocumentPrototypeFunctionCreateEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
