...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSHTMLLegendElement.prototype]]");
    return JSC::cacheGlobalObject<JSHTMLLegendElementPrototype>(exec, *prototypeIdentifier);
}
...
{
    static const Identifier* constructorIdentifier = new Identifier(exec, "[[HTMLLegendElement.constructor]]");
    return JSC::cacheGlobalObject<JSHTMLLegendElementConstructor>(exec, *constructorIdentifier);
}
