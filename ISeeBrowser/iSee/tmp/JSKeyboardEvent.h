...
public:
    JSKeyboardEvent(JSC::JSObject* prototype, KeyboardEvent*);
...
public:
    ...
    JSKeyboardEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSUIEventPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsKeyboardEventPrototypeFunctionInitKeyboardEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
