...
public:
    JSSVGPathSegLinetoHorizontalAbs(JSC::JSObject* prototype, SVGPathSegLinetoHorizontalAbs*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegLinetoHorizontalAbsPrototype(JSC::ExecState* exec)
