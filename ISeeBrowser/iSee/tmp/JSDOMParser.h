...
public:
    JSDOMParser(JSC::JSObject* prototype, DOMParser*);
    virtual ~JSDOMParser();
...
public:
    ...
    JSDOMParserPrototype(JSC::ExecState* exec)
        : JSC::JSObject(exec->lexicalGlobalObject()->objectPrototype()) { }
};

// Functions

JSC::JSValue* jsDOMParserPrototypeFunctionParseFromString(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
