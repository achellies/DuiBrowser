...
static const HashTable JSSVGFontFaceSrcElementPrototypeTable = { 0, JSSVGFontFaceSrcElementPrototypeTableValues, 0 };
...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSSVGFontFaceSrcElement.prototype]]");
    return JSC::cacheGlobalObject<JSSVGFontFaceSrcElementPrototype>(exec, *prototypeIdentifier);
}

const ClassInfo JSSVGFontFaceSrcElement::s_info = { "SVGFontFaceSrcElement", &JSSVGElement::s_info, 0 , 0 };

JSSVGFontFaceSrcElement::JSSVGFontFaceSrcElement(JSObject* prototype, SVGFontFaceSrcElement* impl)
