...
{
    static const Identifier* prototypeIdentifier = new Identifier(exec, "[[JSHTMLVideoElement.prototype]]");
    return JSC::cacheGlobalObject<JSHTMLVideoElementPrototype>(exec, *prototypeIdentifier);
}
...
{
    static const Identifier* constructorIdentifier = new Identifier(exec, "[[HTMLVideoElement.constructor]]");
    return JSC::cacheGlobalObject<JSHTMLVideoElementConstructor>(exec, *constructorIdentifier);
}
