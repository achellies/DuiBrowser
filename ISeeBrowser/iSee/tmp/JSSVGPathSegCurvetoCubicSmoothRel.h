...
public:
    JSSVGPathSegCurvetoCubicSmoothRel(JSC::JSObject* prototype, SVGPathSegCurvetoCubicSmoothRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoCubicSmoothRelPrototype(JSC::ExecState* exec)
