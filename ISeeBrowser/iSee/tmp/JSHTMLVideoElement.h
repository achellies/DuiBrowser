...
public:
    JSHTMLVideoElement(JSC::JSObject* prototype, HTMLVideoElement*);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSHTMLVideoElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSHTMLMediaElementPrototype::self(exec)) { }
};
