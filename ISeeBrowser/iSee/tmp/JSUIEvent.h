...
public:
    JSUIEvent(JSC::JSObject* prototype, UIEvent*);
...
public:
    ...
    JSUIEventPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSEventPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsUIEventPrototypeFunctionInitUIEvent(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
