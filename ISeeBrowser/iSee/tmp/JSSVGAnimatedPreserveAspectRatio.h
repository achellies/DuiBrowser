...
public:
    JSSVGAnimatedPreserveAspectRatio(JSC::JSObject* prototype, SVGAnimatedPreserveAspectRatio*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGAnimatedPreserveAspectRatioPrototype(JSC::ExecState* exec)
