...
public:
    JSSVGPathSegCurvetoCubicSmoothAbs(JSC::JSObject* prototype, SVGPathSegCurvetoCubicSmoothAbs*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoCubicSmoothAbsPrototype(JSC::ExecState* exec)
