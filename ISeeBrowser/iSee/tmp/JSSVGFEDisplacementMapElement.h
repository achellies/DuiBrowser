...
public:
    JSSVGFEDisplacementMapElement(JSC::JSObject* prototype, SVGFEDisplacementMapElement*);
...
public:
    ...
    JSC::JSValue* getValueProperty(JSC::ExecState*, int token) const;
    JSSVGFEDisplacementMapElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSSVGElementPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsSVGFEDisplacementMapElementPrototypeFunctionGetPresentationAttribute(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
