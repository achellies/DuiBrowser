...
public:
    JSSVGPathSegCurvetoCubicRel(JSC::JSObject* prototype, SVGPathSegCurvetoCubicRel*, SVGElement* context);
...
public:
    ...
    virtual const JSC::ClassInfo* classInfo() const { return &s_info; }
    static const JSC::ClassInfo s_info;
    JSSVGPathSegCurvetoCubicRelPrototype(JSC::ExecState* exec)
