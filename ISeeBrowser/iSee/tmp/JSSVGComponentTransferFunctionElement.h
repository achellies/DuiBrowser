...
public:
    JSSVGComponentTransferFunctionElement(JSC::JSObject* prototype, SVGComponentTransferFunctionElement*);
...
public:
    ...
    JSC::JSValue* getValueProperty(JSC::ExecState*, int token) const;
    JSSVGComponentTransferFunctionElementPrototype(JSC::ExecState* exec)
