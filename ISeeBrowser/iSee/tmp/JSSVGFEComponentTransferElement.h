...
public:
    JSSVGFEComponentTransferElement(JSC::JSObject* prototype, SVGFEComponentTransferElement*);
...
public:
    ...
    JSSVGFEComponentTransferElementPrototype(JSC::ExecState* exec)
        : JSC::JSObject(JSSVGElementPrototype::self(exec)) { }
};

// Functions

JSC::JSValue* jsSVGFEComponentTransferElementPrototypeFunctionGetPresentationAttribute(JSC::ExecState*, JSC::JSObject*, JSC::JSValue*, const JSC::ArgList&);
} // namespace WebCore
