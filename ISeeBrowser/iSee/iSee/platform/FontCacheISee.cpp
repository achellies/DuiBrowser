...
const SimpleFontData* FontCache::getFontDataForCharacters(const Font& font, const UChar* characters, int length)
{
	...
	FontPlatformData* result = getCachedFontPlatformData(font.fontDescription(), font.family().family());
	if (result)
...
{
	return getCachedFontPlatformData(font.fontDescription(), font.family().family());
}
